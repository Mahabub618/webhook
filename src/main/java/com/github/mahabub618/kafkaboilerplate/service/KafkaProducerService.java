...
public class KafkaProducerService {
    ...
    private final KafkaTemplate<String, CommitNotification> kafkaTemplate;

    public KafkaProducerService(KafkaTemplate<String, CommitNotification> kafkaTemplate) {
        this.kafkaTemplate = kafkaTemplate;
    }

    public void sendNotification(String topic, CommitNotification notification) {
        try {
